...
function main() {
    ...
    var calculateAvg = function(el,total,gamesplayed){
        el.html(Math.round(parseInt(total)/parseInt(gamesplayed) *100)/100)
    }
    var statsTable = $j("#statsTable").clone(false).attr("id","pergameavgtable")
    ...
    statsTable.find('.precise').each(function(){
        ...
        classNames = classNames.replace("precise", "pga-prec");
        classNames = classNames.replace("sortableStat", "pga-sortableSt");
        id = "pga" + id;
    ...
    $j("#pergameavgtable .tableHead").html("PER GAME AVERAGES");
    ...
    var rankValues = function (columnId) {
        ...
        $j("#pergameavgtable " + columnId).each(function(){
    ...
    rankValues(".pga-sortableSt22");
    rankValues(".pga-sortableSt20");    
    rankValues(".pga-sortableSt17");
    rankValues(".pga-sortableSt16");
    rankValues(".pga-sortableSt6");
    rankValues(".pga-sortableSt3");
    rankValues(".pga-sortableSt2");
    rankValues(".pga-sortableSt1");
    rankValues(".pga-sortableSt0");
    
    var j = 0;
    $j("#pergameavgtable .sortableGP").each(function(){   
        var total = 0;
    ...
    /*
    j = 0;
    $j("#pergameavgtable .sortableMoves").each(function(){   
        var total = 0;
        for (var k = 0; k < teamValues[j].length; k++) {            
            total += teamValues[j][k];            
        }               
